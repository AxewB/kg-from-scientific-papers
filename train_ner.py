...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SciBERT NER on SciERC.")
    ...
    parser.add_argument("--output-dir", default="artifacts/ner", help="Directory for trained checkpoint.")
...
def main() -> None:
    ...
    args = parse_args()
    logging.info("Starting NER training CLI...")
    ...
    trainer = SciBERTNERTrainer(config)
    trainer.train(args.train, args.dev)
    logging.info("NER training finished.")
